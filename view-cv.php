...
<main>
    ...
    <section id="testimonials" class="my-5">
        ...
        <div class="container">
            ...
            <div class="section-header mb-5 mt-5">
                <i class="icon icon-title-shape-left me-4"></i>
                <h3 class="headline"> قالو عنة </h3>
                <i class="icon icon-title-shape-right ms-4"></i>
            </div>

            <div class="co-swiper-slider arrows-lg-transparent">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="swiper-slide-content ">
                                <?php @include "./shared-html/testimonial-card.html"; ?>
                            </div>
                        </div>
    ...
    <section id="achievements" class="my-5">
        ...
        <div class="container">
            ...
            <div class="section-header mb-5 mt-5">
                <i class="icon icon-title-shape-left me-4"></i>
                <h3 class="headline"> جوائز تقديرية </h3>
                <i class="icon icon-title-shape-right ms-4"></i>
            </div>

            <div class="co-swiper-slider ">
                <!-- If we need navigation buttons -->
                <div class="swiper-button-prev achievements-button-prev">
                    <i class="icon icon-arrow-left"></i>
                </div>
                <div class="swiper-button-next achievements-button-next">
                    <i class="icon icon-arrow-right"></i>
                </div>
                ...
                <div class="swiper achievements-swiper">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="swiper-slide-content ">
                                <?php @include "./shared-html/achievements-card.html"; ?>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="swiper-slide-content ">
    ...
    <section id="gallery" class="section py-5">
        ...
        <div class="container mb-4">
            ...
            <div class="section-header mb-5">
                <i class="icon icon-title-shape-left me-4"></i>
                <h3 class="headline"> صور الشيخ </h3>
                <i class="icon icon-title-shape-right ms-4"></i>
            </div> <!-- section-header -->
